...
var CmdNew = &cobra.Command{
	...
	Long:  "Create a project project using the repository template. Example: ges new helloworld",
	Run:   run,
}
...
func init() {
	if repoURL = os.Getenv("GES_LAYOUT_REPO"); repoURL == "" {
		repoURL = "https://github.com/wzhanjun/go-echo-skeleton.git"
	}
